...
UBUNTU_TRANSLATION_DOMAIN="usmartbus.landgraf"
...
aptest.commands = bash $$PWD/uSmartBus/tests/autopilot/run
aptest.depends  = sub-uSmartBus

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/uSmartBus/tests/unit 
unittest.depends  = sub-uSmartBus
